import 'package:falletter/core/components/text_form_field/text_form_field_label.dart';
...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final defaultTextStyle = FalletterTextStyle.placeholder.copyWith(
        color: FalletterColor.white).merge(style);
